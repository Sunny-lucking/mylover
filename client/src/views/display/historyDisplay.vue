<template>
  <div class="content_historyDisplay">
    <div style="--van-nav-bar-icon-color: #f19290">
      <van-nav-bar title="总结报告中心" left-text="" left-arrow @click-left="onClickLeft" />
    </div>
    <div class="historyDisplay">
      <div style="z-index: 999; transform: translate(1.5vh, 27vh)">
        <van-swipe indicator-color="aquamarine" lazy-render>
          <van-swipe-item :autoplay="3000" lazy-render v-for="image in images" :key="image" show-indicators="false">
            <div style="
                z-index: 99;
                position: flex;
      ...
      <div style="z-index: 2; transform: translate(2vh, -49vh); width: 60%">
        ...
        <div style="z-index: 2; transform: translate(0px, -4vh); font-size: 3.5vh">
          <h14>总结任务报告</h14>
        </div>
        <div style="z-index: 2; transform: translate(0px, -3vh); font-size: 2.8vh">
      ...
      <div style="
        ...
        <div style="z-index: 2; transform: translate(2vw, -26vh)">
          ...
          <div style="z-index: 2; transform: translate(2vh, 3px); font-size: 1.5vh">
            <h14>扫描二维码，关注更多吧！</h14>
          </div>
